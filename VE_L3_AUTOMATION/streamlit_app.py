...
CREATE OR REPLACE TABLE ''' + table_name + ''' AS (
    SELECT
            ...
            DIV0(SUM(sub.price_per_credit*CREDITS),NULLIF(SUM(CREDITS),0)) as price_per_credit,
            DIV0(SUM(sub.overage_price_per_credit*CREDITS),NULLIF(SUM(CREDITS),0)) as credit_list_price,
